...
wget -q -O - https://download.virtualbox.org/virtualbox/5.2.36/virtualbox-5.2_5.2.36-135684~Ubuntu~xenial_amd64.deb
...
dpkg -i virtualbox-5.2_5.2.36-135684~Ubuntu~xenial_amd64.deb
